            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Chào mừng đến <span class="text-primary text-uppercase">RoomBook</span></h1>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" herf="#">
                            ...
                            <p class="text-body mb-0">Dịch vụ cung cấp lựa chọn đa dạng về phòng và căn hộ, đảm bảo thoải mái và tiện nghi cho khách hàng.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <a class="service-item rounded" herf="#">
                            ...
                            <p class="text-body mb-0">Trải nghiệm ẩm thực tuyệt vời với đồ ăn ngon và dịch vụ tận tâm từ các nhà hàng chất lượng.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="service-item rounded" herf="#">
                            ...
                            <h5 class="mb-3">Spa & Thư giãn</h5>
                            <p class="text-body mb-0">Trải qua những phút giây thư giãn tuyệt vời trong không gian spa sang trọng và chăm sóc cơ thể chuyên nghiệp.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <a class="service-item rounded" herf="#">
                            ...
                            <h5 class="mb-3">Thể thao</h5>
                            <p class="text-body mb-0">Cơ hội thể hiện sức khỏe và đam mê thể thao với các hoạt động và tiện ích thể thao hiện đại.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="service-item rounded" herf="#">
                            ...
                            <p class="text-body mb-0">Tổ chức sự kiện và tiệc tùng độc đáo với dịch vụ chuyên nghiệp và không gian sang trọng.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <a class="service-item rounded" herf="#">
                            ...
                            <p class="text-body mb-0">Trang bị phòng tập GYM và lớp học Yoga để đảm bảo sự khỏe mạnh và cân bằng tinh thần cho khách hàng.</p>
                        </a>
                    </div>
                </div>
            </div>
