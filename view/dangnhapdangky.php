<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                    <form action="index.php?act=dangky-dangnhap" method="post">
                        <div class="row g-3">
                            <div class="col-12">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-md-6">
                <h6 class="section-title text-start text-primary text-uppercase">Đăng Ký</h6>
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                    <form action="index.php?act=dangky-dangnhap" method="post">
                        <div class="row g-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <input type="submit" value="Đăng Ký" class="btn btn-primary w-100 py-3" name="dangky">
                            </div>
                        </div>
                    </form>
                </div>
