...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">Phòng <span class="text-primary text-uppercase"><?php $ten_phong = loadten_phong($_SESSION['id_phong']);echo $ten_phong?></span></h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-6">
                <div class="row g-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="date" id="date3" data-target-input="nearest">
                                    <input type="text" name="ngayden" class="form-control datetimepicker-input" placeholder="Check In"
                                        data-target="#date3" data-toggle="datetimepicker" value="<?php 
                            ...
                            <div class="col-md-6">
                                <div class="date" id="date4" data-target-input="nearest">
                                    <input type="text" name="ngaydi" class="form-control datetimepicker-input" placeholder="Check Out"
                                        data-target="#date4" data-toggle="datetimepicker" value="<?php 
                            ...
                            <div class="col-12">
                                <input class="btn btn-primary w-100 py-3" type="submit" name="datphong" value="Đặt Ngay">
                            </div>
                        </div>
                    </form>
                </div>
