            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="indexuser.php?act=updatekh" method="post">
                                <?php
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập" name="ten" value="<?= $ten ?>">
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Tuổi</span>
                                    <input type="text" class="form-control" placeholder="Nhập" name="tuoi" value="<?= $tuoi ?>">
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập" name="diachi" value="<?= $diachi ?>">
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Số CCCD</span>
                                    <input type="text" class="form-control" placeholder="Nhập" name="CCCD" value="<?= $CCCD ?>">
                                </div>
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <input type="hidden" name="id_TK" value="<?= $id_TK ?>">
                                    <input type="submit" value="Lưu" class="btn btn-primary" name="capnhatkh">
